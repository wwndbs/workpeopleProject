										...
										<script>
											...
											$(function(){
												...
												$(".d5>span").click(function(){
													location.href = 'detail.ma?no=' + $(this).parent().siblings().eq(0).children().val() + '&boxType=5';
												})
												...
												$(document).on("click", "ion-icon[name=copy-outline]", function(){
													...
													let url = 'detail.ma?no=' + $(this).parent().siblings().eq(0).children().val() + '&boxType=5&preview=2'; 
								...
								<div class=" d-flex justify-content-end" style="justify-content:center !important; ">
									<ul class="pagination pagination-clean pagination-sm mb-0">
										<c:choose>
											...
											<c:otherwise>                    
												<li class="page-item">
										    		<a class="page-link" href="box.ma?cpage=${ pi.currentPage - 1 }&boxType=5" tabindex="-1">‹</a>
												</li>
											</c:otherwise>
										</c:choose>
	
										<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">    
											<li class="page-item"><a class="page-link" href="box.ma?cpage=${ p }&boxType=5">${ p }</a></li>
										</c:forEach>
										...
										<c:choose>
											...
											<c:otherwise>
												<li class="page-item">
													<a class="page-link" href="box.ma?cpage=${ pi.currentPage + 1 }&boxType=5">›</a>
												</li>
											</c:otherwise>
										</c:choose>
									</ul>
