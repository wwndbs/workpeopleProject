                        ...
                        <div id="mtr2">
                            ...
                            <form id="mtrForm" method="post" action="" enctype="multipart/form-data">
                                ...
                                <table id="meetingRoomTable" align="center">
                                    ...
                                    <tr>
                                        <td colspan="4"><input placeholder="회의실 이름" style="height: 30px;"></td>
                                    ...
                                    <tr style="height: 80px">
                                        ...
                                        <td style="font-weight:800; width: 120px;">면적 :</td>
                                        <td style="width:60px;"><input placeholder="면적" style="height: 30px;"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input placeholder="수용인원" style="height: 30px;">
                                        </td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input placeholder="최저이용시간" style="height: 30px;">
                                        </td>
                                        <td colspan="3"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="submit" id="meetingbtn" style="height:30px; width:80px">등록</button>
                                        </td>
                                        <td>
