...
<!-- 						<div class="search-area">
	...
	<script>
		function insertPage(num){
			switch(num){
				case 1 : location.href="document.ap?form=연장근무신청서"; break;
				case 2 : location.href="document.ap?form=휴가신청서"; break;
				case 3 : location.href="document.ap?form=결근사유서"; break;
				case 4 : location.href="document.ap?form=업무기안서"; break;
			}
		}
	</script>
</body>
